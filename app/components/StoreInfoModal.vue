              ...
              <div class="section-content">
                <div class="map-container">
                  ...
                  <div class="map-info">
                    ...
                    <p><strong>Telefone:</strong> {{ storeSettings.storePhone || 'Telefone não informado' }}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="section-content">
                <div class="contact-info">
                  <div class="contact-item">
                    ...
                    <span>{{ storeSettings.storePhone || 'Telefone não informado' }}</span>
                  </div>
                  <div class="contact-item" v-if="storeSettings.whatsapp">
                    <svg class="contact-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
